# PolyForm Noncommercial License 1.3.3.7

**SCRAMBLR** edition  
https://github.com/scramblr/licenses/PolyForm-Noncommercial-1.3.3.7.md
...
SCRAMBLR grants you a copyright license for the software to do  
everything you might do with the software that would otherwise  
infringe SCRAMBLR's copyright in it for any permitted purpose.  
However, you may only distribute the software according to  
[Distribution License](#distribution-license) and make changes  
or new works based on the software according to  
[Changes and New Works License](#changes-and-new-works-license).

## Distribution License

SCRAMBLR grants you an additional copyright license to distribute  
...
`Required Notice:` that SCRAMBLR provided with the software.

You must also include the full text (or a direct link to) the  
**Required Notice** file:  
https://github.com/scramblr/licenses/PolyForm-REQUIRED_NOTICE-1.3.37.txt

## Changes and New Works License

SCRAMBLR grants you an additional copyright license to make  
changes and new works based on the software for any permitted  
purpose.

## Patent License

SCRAMBLR grants you a patent license for the software that covers  
patent claims SCRAMBLR can license, or becomes able to license,  
...
**Commercial, corporate, for-profit, or any other business use is  
not permitted** under this license.

If you wish to use the software (or any modification of it) for  
any commercial, business, or for-profit purpose, you must obtain  
a separate commercial license from SCRAMBLR.

Please contact us at **scramblr@blackhats.ru** for licensing options  
...
licenses to anyone else, or prevent SCRAMBLR from granting licenses  
...
warranty or condition, and SCRAMBLR will not be liable to you for  
any damages arising out of these terms or the use or nature of the  
software, under any kind of legal claim.***

## Definitions

The **licensor** is SCRAMBLR, and the **software** is the software  
SCRAMBLR makes available under these terms.
