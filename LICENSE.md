...
### Author’s Intent & Restrictions

This software, code, instructions, or other attached works (collectively known here-forth as "software") are provided as artistic expressions by the author, most commonly known as "notdan" AKA "scramblr",
and are licensed in a very specific way that aligns most closely with the author's personal ethics and outward intent through the PolyForm Noncommercial License 1.0.0. The PolyForm License, and the author,
intends for these artistic expression(s) AKA "Software" to be used in a manner which is **ONLY intended for individual personal, NATURALLY BORN PERSON(S), for non-commercial, non-revenue generating use only.**

WARNING: Unlicensed use by any business, persons conducting business, corporation(s), government(s), research or educational instition(s), non-profit organization(s), 
or _**ANY NON-NATURAL PERSON(S)**_ without first obtaining a seperate exclusion or paid license **will result in litigation seeking the maximum legally allowed penalty for unauthorized use, in a Court of Law.** 
